...
(201, 22111080, 'Kholishah Nailah', 'Cuti Liburan', 'ingin berlibur', '2024-12-26', '2025-01-2', '8 hari', 'Disetujui');
-- --------------------------------------------------------
...
--
ALTER TABLE `data_karyawan`
  MODIFY `nip` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
